"""
Main training script for SALSA with ERM (Empirical Risk Minimization).
This is the standard training approach without GroupDRO.
"""
import os
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description='Train SALSA model with ERM')
    ...
    config.use_group_dro = False  # ERM training
